                    ...
                    @foreach($orders as $order)
                        @php
                            ...
                            if($order->status == 'shipped'){
                                $status = '<span class="bg-green-400 py-1 px-3 rounded text-white shadow"> Shipped </span>';
                            }
                             ...
                             if($order->status == 'cancelled'){
                                $status = '<span class="bg-red-700 py-1 px-3 rounded text-white shadow"> Canceled </span>';
                            }
                        ...
                        <tr wire:key="{{ $order->id }}" class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-900 dark:even:bg-slate-800">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $order->grand_total, 'INR' }}</td>
